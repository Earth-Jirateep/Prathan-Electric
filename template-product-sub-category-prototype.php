<?php
/**
 * Template Name: Product Sub Category Protyotype
...
<main id="main" class="site-main">
    ...
    <section class="section-pagination">
        <div class="section-pagination-wrapper">
            ...
            <a href="#" class="section-pagination-paragraph-box">
                <p class="section-pagination-paragraph">สายไฟ THW IEC01</p>
            </a>
        </div>
    </section>
        ...
        <div class="section-hero-page-wrapper">
            <div class="section-hero-page-box">
                <div class="section-hero-page-header-box">
                    <h1 class="section-hero-page-header">สายไฟ THW IEC01</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-our-products background-white">
        <div class="section-our-products-wrapper">
            ...
            <div class="section-our-products-item-container">
                ...
                <?php
                $current_slug = ''; // เก็บ Slug ของหน้าปัจจุบัน

                // ตรวจสอบว่าเป็นหน้า Single ของ Subcategory หรือไม่
                if (is_singular('subcategory')) {
                    ...
                    <div class="section-our-products-item-select-wrapper product-category-prototype swiper-wrapper">
                        ...
                        <?php if ($query->have_posts()) : ?>
                            <?php while ($query->have_posts()) : $query->the_post();
                                $link = get_permalink(); // ดึง Permalink ของ Subcategory
                                $slug = get_post_field('post_name', get_the_ID()); // ดึง Slug ของแต่ละ Subcategory

                                // ตรวจสอบว่าหน้าปัจจุบันตรงกับ Slug หรือไม่
                                $active_class = ($slug === $current_slug) ? 'active' : '';
                            ?>
                                <a href="<?php echo esc_url($link); ?>" class="section-our-products-item-select-box product-category-prototype swiper-slide <?php echo $active_class; ?>">
